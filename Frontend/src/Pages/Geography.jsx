            ...
            <div className="container mx-auto h-auto flex flex-col md:flex-row justify-center md:space-x-8 mt-12 space-y-12 md:space-y-0 mb-8">
                <div className="transform hover:scale-105 transition duration-300 w-full max-w-sm">
                    <div className="card bg-white rounded-lg shadow-2xl">
                        ...
                        <div className="p-6">
                            <h2 className="font-semibold  text-center text-4xl font-baloo text-red-600 mt-4">Explore the World</h2>
                ...
                <div className="transform hover:scale-105 transition duration-300 w-full max-w-sm">
                    <div className="card bg-white rounded-lg shadow-2xl">
                        ...
                        <div className="p-6">
                            <h2 className="font-semibold  text-center text-4xl font-baloo text-blue-600 mt-4">Learn with Videos</h2>
                            <div className="card-actions justify-center mt-6">
                ...
                <div className="transform hover:scale-105 transition duration-300 w-full max-w-sm">
                    <div className="card bg-white rounded-lg shadow-2xl">
                        ...
                        <div className="p-6">
                            <h2 className="font-semibold text-center text-4xl font-baloo text-green-600 mt-4">Get Study Notes</h2>
                            <div className="card-actions justify-center mt-6">
